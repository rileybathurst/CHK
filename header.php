			...
			<!-- <div class="off-canvas-content"> -->
				...
				<!-- <div class="top-bar show-for-medium hide-for-print">
				  ...
				  <div class="top-bar-right">
					<ul class="menu border-spacing-top-bar">
						 php if ( is_user_logged_in() ) { ?>
							<li class="spacer"><p><a href=" php echo home_url(); ?>/contact" class="button san-serif"> php echo (get_page_by_title('Contact Us')->post_title); ?></a></p></li>
							<li><p><a href=" php echo home_url(); ?>/logout" class="button san-serif">logout</a></p></li>
						 php } else { ?>
				...
				<header class="hide-for-print">
					...
					<div class="small-nav hide-for-print"> <!-- being top level of the grid makes the button want to be full height -->
						<button>Menu</button><!-- toggle off canvas -->
					</div>
				</header>
