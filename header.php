	...
	<body>
		...
		<div id="minimenu" class="hide-for-print">
			<?php if ( has_custom_logo() ) { ?>
				...
				<span class="screen-reader block"><?php echo get_bloginfo( 'name' ); ?></span>
			<?php } else { ?>
		...
		<section class="top-bar hide-for-print">
			...
			if ( $contact == '') { //no page throw an error purposley so it's obvious -->
				...
				<a href="<?php echo home_url(); ?>/contact" class="top-bar--contact"><?php echo (get_page_by_title('Contact Us')->post_title); ?></a>
			<?php } ?>
		</section>
