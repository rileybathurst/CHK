...
<div>
	<?php if ($order->salami_italian >= 1) { ?>
		<span class="unicode highlights spacer">✓</span>
	<?php } else { ?>
		<span class="unicode spacer hide-for-print">✗</span>
	<?php } ?>
	<strong>Italian Salami</strong>

	<?php if ($order->salami_italian >= 1) { 
		echo $order->salami_italian . ' #';
	} else { echo '&nbsp;'; }

	if ($order->salami_italian >= 1) { 
...
<div>
	<?php if ($order->t_bbq_grill_stick >= 1) { ?>
		<span class="unicode highlights spacer">✓</span>
	<?php } else { ?>
		<span class="unicode spacer hide-for-print">✗</span>
	<?php } ?>
	<strong>BBQ Grill Stick</strong>
