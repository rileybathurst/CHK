<div class="row bright hide-for-print">
    <div class="small-12 medium-9 columns">
        ...
        <ul class="inline drop">
            ...
            <li><a href="<?php echo home_url(); ?>/contact"><?php echo (get_page_by_title('contact')->post_title); ?></a></li> 
        ...
        <ul class="inline">    
            ...
            <li><a href="http://rileybathurst.com">Site by Riley Bathurst Design</a></li> 
        </ul>
