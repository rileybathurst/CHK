				...
				while (have_posts()) : the_post(); ?>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>><!-- post open -->
						...
						<form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" id="small-order" method="post">
							...
							<!-- individual_packs -->
							<div>
								<label for="individual_packs">sausage labelling for individual packs<br/><em>additional $0.50 per kg</em></label>
								<input type="checkbox" id="individual_packs" name="individual_packs" />
							</div>
							...
							<h4>SALAMI</h4>
								...
								<div class="salami">
									<label for="salami_italian">Italian Flavour Salami</label>
									<input type="number" pattern="\d*" id="salami_italian" name="salami_italian" />
								
									<select id="salami_italian_s" name="salami_italian_s">
										<option value="" disabled selected>Strength</option>
										<option value="strong">Strong</option>
										<option value="mild">Mild</option>
									</select>
							...
							<div>
								...
								<h4>BBQ GRILL STICK</h4>

							<div>
								<label for="t_bbq_grill_stick">BBQ Grill Stick</label>
								<input type="number" pattern="\d*" id="t_bbq_grill_stick" name="t_bbq_grill_stick" />
								<span class="postfix">KG</span>

								<select id="bbq_grill_stick_t" name="bbq_grill_stick_t">
									<option value="" disabled selected>Select</option>
