...
<div>
	<p>
		<?php if ($order->individual_packs == 1) { ?>
			<span class="unicode check spacer">✓</span>
		<?php } else { ?>
			<span class="unicode cross spacer">✗</span>
		<?php } ?>
		<input type="hidden" name="individual_packs" value="<?php echo $order->individual_packs; ?>">
		<strong>Sausage labelling for individual packs</strong>
	</p>
</div>
...
<!-- salami_italian salami_italian_s -->
<div>
	<p>
		Italian Salami
		<?php if ($order->salami_italian != '') { 
			echo $order->salami_italian . ' KG';
			}; ?>
		<input type="hidden" name="salami_italian" value="<?php echo $order->salami_italian; ?>">
		
		<?php if ($order->salami_italian != '') { 
			echo $order->salami_italian_s;
		}; ?>
		<input type="hidden" name="salami_italian_s" value="<?php echo $order->salami_italian_s; ?>">
	</p>
</div>
...
<h3>BBQ GRILL STICK</h3>

<!-- t_bbq_grill_stick bbq_grill_stick_t -->
<div>
	<p>
		BBQ Grill Stick
		<?php if ($order->t_bbq_grill_stick != '') { 
			echo $order->t_bbq_grill_stick . ' KG';
		}; ?>
		<input type="hidden" name="t_bbq_grill_stick" value="<?php echo $order->t_bbq_grill_stick; ?>">
